...
kotlin {
    ...
    val xcf = XCFramework("TsRs")

    macosArm64 {
        binaries.framework { baseName = "TsRs"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework {
            baseName = "TsRs"
    ...
    swiftExport {
        moduleName = "TsRs"
        flattenPackage = "io.github.kotlinmania.tsrs"
    }

    android {
        namespace = "io.github.kotlinmania.tsrs"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "ts-rs-kotlin", version.toString())

    pom {
        name.set("ts-rs-kotlin")
        description.set("Kotlin Multiplatform port of Aleph-Alpha/ts-rs - generate typescript bindings from rust types")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/ts-rs-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/ts-rs-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/ts-rs-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/ts-rs-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTsRsXCFramework",
    "assembleTsRsDebugXCFramework",
    "assembleTsRsReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTsRsXCFramework",
    "assembleReleaseIosFatFrameworkForTsRsXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTsRsXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTsRsXCFramework",
    "assembleDebugMacosFatFrameworkForTsRsXCFramework",
    "assembleReleaseMacosFatFrameworkForTsRsXCFramework",
    "assembleDebugTvosFatFrameworkForTsRsXCFramework",
    "assembleReleaseTvosFatFrameworkForTsRsXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTsRsXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTsRsXCFramework",
    "assembleDebugWatchosFatFrameworkForTsRsXCFramework",
    "assembleReleaseWatchosFatFrameworkForTsRsXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTsRsXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTsRsXCFramework",
