...
This file is the quick-reference operating contract for ts-rs-kotlin. The longer
...
ts-rs-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`ts-rs`](https://crates.io/crates/ts-rs). Upstream Rust is the behavioral oracle while the
