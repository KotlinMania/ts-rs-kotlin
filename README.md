# ts-rs-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fts--rs--kotlin-blue.svg)](https://github.com/KotlinMania/ts-rs-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/ts-rs-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/ts-rs-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/ts-rs-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/ts-rs-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`Aleph-Alpha/ts-rs`](https://github.com/Aleph-Alpha/ts-rs).

**Original Project:** This port is based on [`Aleph-Alpha/ts-rs`](https://github.com/Aleph-Alpha/ts-rs). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `Aleph-Alpha/ts-rs`

> The text below is reproduced and lightly edited from [`https://github.com/Aleph-Alpha/ts-rs`](https://github.com/Aleph-Alpha/ts-rs). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
This Kotlin port is distributed under the same MIT license as the upstream [`Aleph-Alpha/ts-rs`](https://github.com/Aleph-Alpha/ts-rs). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.
...
Thanks to the [`Aleph-Alpha/ts-rs`](https://github.com/Aleph-Alpha/ts-rs) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
