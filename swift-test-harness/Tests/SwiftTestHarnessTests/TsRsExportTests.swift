...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `TsRs.swiftmodule/`
...
//      `import TsRs` above would fail at compile time.
//
//   2. The static archive `libTsRs.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "TsRs" }` and
//      `flattenPackage = "io.github.kotlinmania.tsrs"` configuration in
...
final class TsRsExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "TsRs swift module imported cleanly")
    }
}
